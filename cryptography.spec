...
Version  : 3.0
Release  : 126
URL      : https://github.com/pyca/cryptography/archive/3.0/cryptography-3.0.tar.gz
Source0  : https://github.com/pyca/cryptography/archive/3.0/cryptography-3.0.tar.gz
...
%prep
%setup -q -n cryptography-3.0
cd %{_builddir}/cryptography-3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597678418
...
cp %{_builddir}/cryptography-3.0/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/cryptography/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography-3.0/LICENSE.BSD %{buildroot}/usr/share/package-licenses/cryptography/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
cp %{_builddir}/cryptography-3.0/LICENSE.PSF %{buildroot}/usr/share/package-licenses/cryptography/acf6b1628b04fe43a99071223cdbd7b66691c264
cp %{_builddir}/cryptography-3.0/vectors/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/cryptography/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography-3.0/vectors/LICENSE.BSD %{buildroot}/usr/share/package-licenses/cryptography/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
